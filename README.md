...
After dowloading the pywikibot framework and lmxl your can start the bot with one of the following command :

Linux : python main.py <path> <user name> <password> (<lexeme_only>)
Windows : py main.py <path> <user name> <password> (<lexeme_only>)
